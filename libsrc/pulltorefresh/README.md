# Pull To Refresh for Android [![Build Status](https://travis-ci.org/mamewotoko/android-pulltorefresh.svg?branch=gradle)](https://travis-ci.org/mamewotoko/android-pulltorefresh)
